...
class NotionUtils(object):
    ...
    def createDetail(self, detail: Detail):
        ...
        row.poc = "[{} ({})](https://wa.me/65{})".format(detail.POC,
                                                         detail.POCContact, detail.POCContact)
    ...
    def insertDetailToNotion(self, source):
        ...
        for detail in my_detail:
            veh_ref = self.createVehicleMidTypeRecord(
            ...
            detail.setRef(veh_ref, boc_ref, reporting_ref,
                          destination_ref_list)
